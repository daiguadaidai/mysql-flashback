module github.com/daiguadaidai/mysql-flashback
...
require (
	...
	github.com/tikv/client-go/v2 v2.0.8-0.20231116065855-46811b6ac353 // indirect
	github.com/tikv/pd/client v0.0.0-20231116062916-ef6ba8551e52 // indirect
